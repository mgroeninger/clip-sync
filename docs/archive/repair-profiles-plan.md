...
> **Status:** **Shipped** (2026-06-22). Phases 1–4 complete. Phase 5 deferred (verbose hint only; no auto `anchored_retry`). Archived copy: [archive/repair-profiles-plan.md](archive/repair-profiles-plan.md).
