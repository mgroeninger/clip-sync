...
> **Status:** Shipped (2026-06-17). Delivered **combined** with [anchored end extraction](anchored-end-extraction-plan.md). Archived from `docs/TEMP-anchored-interior-extraction-plan.md`.
