...
- **Active drafts:** `TEMP-*.md` in this folder. Currently: [TEMP-gap-selection-plan.md](TEMP-gap-selection-plan.md) (v1 **done**), [TEMP-gap-selection-ranges-plan.md](TEMP-gap-selection-ranges-plan.md) (v1.5 **done**), [TEMP-scan-recipe-plan.md](TEMP-scan-recipe-plan.md) (parked until a consumer), [TEMP-gap-selection-deferred.md](TEMP-gap-selection-deferred.md), [TEMP-nway-donor-alignment-plan.md](TEMP-nway-donor-alignment-plan.md).
