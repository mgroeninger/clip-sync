...
- **Active drafts:** `TEMP-*.md` in this folder. Currently: [TEMP-fingerprint-provenance-plan.md](TEMP-fingerprint-provenance-plan.md) (**split out 2026-07-31**; §2 blocks the next large fingerprint run), [TEMP-nway-donor-alignment-plan.md](TEMP-nway-donor-alignment-plan.md).
- **Recently archived:** [archive/TEMP-gap-selection-deferred.md](archive/TEMP-gap-selection-deferred.md) — refused `--scan-window` (durable note in [gap-vocabulary.md](gap-vocabulary.md)) + `--gaps-from` sketch, **archived 2026-07-31**. · [archive/TEMP-scan-recipe-plan.md](archive/TEMP-scan-recipe-plan.md) — `ScanRecipe` + JSON scan-params echo, **archived 2026-07-31**.
