...
- **Active drafts:** `TEMP-*.md` in this folder. Currently: [TEMP-fill-normalize-boost-only-plan.md](TEMP-fill-normalize-boost-only-plan.md) (A-border normalize: boost only, never attenuate), [TEMP-nway-donor-alignment-plan.md](TEMP-nway-donor-alignment-plan.md), [TEMP-flac-output-plan.md](TEMP-flac-output-plan.md).
- **Recently archived:** [archive/TEMP-fingerprint-field-clarity-plan.md](archive/TEMP-fingerprint-field-clarity-plan.md) — rename five high-confusion wire fields (R1–R3) + co-locate `_contract` on eight metric groups (C1/C2), **archived 2026-08-08**; C3 deferred to [BACKLOG.md](../../BACKLOG.md) § *Fingerprint contract follow-ups (C3)*; durable behaviour in [gap-fingerprint.md](gap-fingerprint.md) § *`_contract`* and § *Shape*. · [archive/TEMP-residual-abstention-reporting-plan.md](archive/TEMP-residual-abstention-reporting-plan.md) — name *why* a residual carries no usable headroom reading, in production output and in dumps, **archived 2026-08-05**; durable behaviour in [../json-output.md](../json-output.md) § *SeamResidualVerdict* and [gap-fingerprint.md](gap-fingerprint.md) § *Gate recipe*. · [archive/TEMP-donor-apply-edge-exclusion-plan.md](archive/TEMP-donor-apply-edge-exclusion-plan.md) — head/tail Apply → nominal classify by A-span edge, **archived 2026-08-05**; durable behaviour in [gap-scan.md](../gap-scan.md) § Donor registration. · [archive/TEMP-gap-listen-wav-plan.md](archive/TEMP-gap-listen-wav-plan.md) — `--gap-listen [DIR]` WAV side channel on `--gap-fingerprints` (one decode), **archived 2026-08-04**; durable behaviour in [gap-fingerprint.md](gap-fingerprint.md) § *`--gap-listen`*. · [archive/TEMP-fingerprint-provenance-plan.md](archive/TEMP-fingerprint-provenance-plan.md) — fingerprint-dump source + measurement provenance, Tracks A and B shipped, **archived 2026-07-31**; durable behaviour in [gap-fingerprint.md](gap-fingerprint.md). · [archive/TEMP-gap-selection-deferred.md](archive/TEMP-gap-selection-deferred.md) — refused `--scan-window` (durable note in [gap-vocabulary.md](gap-vocabulary.md)) + `--gaps-from` sketch, **archived 2026-07-31**. · [archive/TEMP-scan-recipe-plan.md](archive/TEMP-scan-recipe-plan.md) — `ScanRecipe` + JSON scan-params echo, **archived 2026-07-31**.
