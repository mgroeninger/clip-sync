...
- **Active drafts:** `TEMP-*.md` in this folder. Currently: [TEMP-nway-donor-alignment-plan.md](TEMP-nway-donor-alignment-plan.md), [TEMP-flac-output-plan.md](TEMP-flac-output-plan.md), [TEMP-fingerprint-field-clarity-plan.md](TEMP-fingerprint-field-clarity-plan.md) (rename + co-located `_contract`).
