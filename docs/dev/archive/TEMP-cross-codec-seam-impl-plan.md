...
**Synthetic assets** ([archive/TEMP-w5-timing-offset-diag-plan.md](TEMP-w5-timing-offset-diag-plan.md),
...
| [archive/TEMP-w5-timing-offset-diag-plan.md](TEMP-w5-timing-offset-diag-plan.md) | Synthetic shape regression only |
