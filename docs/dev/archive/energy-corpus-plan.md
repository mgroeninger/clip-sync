...
>
> **Archived** to `docs/dev/archive/energy-corpus-plan.md`. Parent `TEMP-energy-signature-plan.md` Phase 3, `corpus-validation.md` § Energy signature corpus, and `gap-repair-guide.md` all updated. (Frozen record — outbound links are relative to the original `docs/` location.)
...
- [x] Cross-link from [TEMP-energy-signature-plan.md](TEMP-energy-signature-plan.md) (Phase 3 references this corpus + EC-6); this doc archived to `docs/dev/archive/energy-corpus-plan.md`.
...
| `docs/dev/corpus-validation.md` | § Energy signature production corpus + matrix row format |
