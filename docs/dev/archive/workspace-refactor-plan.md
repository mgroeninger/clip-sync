...
| `docs/dev/corpus-matrix.md` | Case design matrix |
| `docs/dev/corpus-validation.md` | Harness overview + CI |
| `tests/corpus/README.md` | Fixture ops (regenerate, size budget) |
| `docs/dev/archive/` | Historical — no path updates |
| `docs/dev/archive/TEMP-clip-self-repetition-plan.md` | Active feature plan → `docs/dev/archive/clip-self-repetition-plan.md` when shipped |
| `docs/dev/archive/TEMP-offset-verification-plan.md` | Active feature plan → `docs/dev/archive/offset-verification-plan.md` when shipped |
...
|----------|-------------|
| [docs/dev/corpus-validation.md](docs/dev/corpus-validation.md) | Phase 3 — commands → `cargo test -p clip-sync --features test-utils corpus_`; harness path → `crates/clip-sync/src/application/testing/corpus_fixtures.rs` |
...
| [docs/dev/corpus-matrix.md](docs/dev/corpus-matrix.md) | Only if case ids or tiers change |
...
| Archived plans under `docs/dev/archive/` | **No edits** — historical paths |
...
| 3.5 | Update [docs/dev/corpus-validation.md](docs/dev/corpus-validation.md) and [tests/corpus/README.md](tests/corpus/README.md) — paths and `cargo test -p clip-sync …` commands. |
...
- [ ] [docs/dev/corpus-validation.md](docs/dev/corpus-validation.md) + [tests/corpus/README.md](tests/corpus/README.md) — lib harness path, `cargo test -p clip-sync corpus_` (Phase 3.5).
- [ ] [docs/error-mapping.md](docs/error-mapping.md) — repair exit codes (Phase 4).
- [ ] Archive to `docs/dev/archive/workspace-refactor-plan.md` when Phases **1–3** complete (note repair 4–5 in archive header if still open).
