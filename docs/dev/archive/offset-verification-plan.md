...
> **Status:** ✅ Shipped (Phases 1–3 complete). Archived to `docs/dev/archive/offset-verification-plan.md`.
...
- [x] Archive this doc → `docs/dev/archive/offset-verification-plan.md`
