...
1. **`docs/dev/corpus-matrix.md`** — authoritative case matrix (dimensions × scenarios × expected results).
...
## 2. Case matrix (`docs/dev/corpus-matrix.md`)
...
Copy this table into `docs/dev/corpus-matrix.md` and keep it in sync with `manifest.toml`.
...
- [x] Create `docs/dev/corpus-matrix.md` (§2 table + tolerance policy).
...
- [x] Delete or archive `docs/dev/archive/TEMP-corpus-implementation-plan.md`.
...
- [x] `docs/dev/corpus-matrix.md` exists and lists ≥ 20 cases with expected outcomes.
