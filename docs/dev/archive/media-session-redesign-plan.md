...
The full pre-ship baseline table, expanded decision rows, and test matrix from the draft plan are omitted here to avoid duplicating [PLAN.md](../../../PLAN.md). See git history for `docs/dev/archive/TEMP-media-session-redesign-plan.md` if needed.
