...
> **Status:** Completed and archived (2026-06-09). R0–R5 shipped. Live copy: [docs/dev/archive/TEMP-repair-write-path-plan.md](../TEMP-repair-write-path-plan.md).
...
- [docs/dev/archive/workspace-refactor-gaps.md](workspace-refactor-gaps.md) — migration Phase 5 origin
