...
| [TEMP-residual-channel-alignment-plan.md](docs/TEMP-residual-channel-alignment-plan.md) | Per-channel residual/floor following Pearson channel selection (P0+P1 done; P2 gate veto + corpus 6ch rows remain) |
...
| `fill_repeat_correlations` channel alignment (low priority) | Repeat-correlation tier still scores all channels mono-style, unlike seam Pearson and residual which now follow energy-selected channels. Separate Pearson/residual repeat alignment. From [TEMP-residual-channel-alignment-plan.md](docs/TEMP-residual-channel-alignment-plan.md) §8 |
