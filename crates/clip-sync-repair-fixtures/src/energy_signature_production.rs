...
pub fn scan_gaps_for_fixture(fixture: &EnergySignatureFixture, temp: &Path) -> GapReport {
    ...
    let request = ScanGapsRequest {
        ...
        recipe: clip_sync_repair::domain::ScanRecipe::with_hold_blocks(
            repair.min_gap_ms,
            repair.silence_hold_blocks(),
            repair.scan_block_ms,
            repair.silence_peak_fraction,
            repair.absolute_silence_rms,
        ),
        scan_both: false,
